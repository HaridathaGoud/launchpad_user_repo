        ...
        <>
            ...
            <div className="container mx-auto pt-5 px-3 lg:px-0">
                ...
                <div className='grid md:grid-cols-12 lg:gap-[45px]'>
                    ...
                    <div className={` ${props?.type === 'profile' || props?.type ==='topSellers' ? '!md:col-span-12 xl:col-span-12 lg:col-span-12':'col-span-12 md:col-span-8 lg:col-span-8 xl:col-span-9'} `}>
                        {localState?.activeContent === 'content1' && <div className={`grid md:grid-cols-2 xl:grid-cols-3 gap-[16px] ${props?.type === 'profile' || props?.type ==='topSellers' ? 'xl:grid-cols-4 lg:grid-cols-4':''}`}>
                            {data &&
                                !localState?.loader &&
                                data?.map((item: any) => (
                                    <div
                        ...
                        {localState.activeContent === 'content2' && (
                            <ListView data={nftDetails[props?.type]}  sendSaveView={saveView}/>)}
