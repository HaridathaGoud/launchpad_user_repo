  ...
  return (
    <div className=" rounded-lg header-shadow relative shadow-md h-full">
      <div className="relative">
        <video
          controls
          className="rounded-t-lg h-[546px] w-full object-cover"
          muted
        >
          ...
          <div className="h-full absolute pt-12 md:pt-24 top-0 bg-[#00000040] w-full text-center max-sm:px-4">
            {showConfirmation ? (
              ...
              <div>
                ...
                <p className="text-error-content mt-3 mb-6">
                  Connect with one of available wallet providers or create a{" "}
                  <br /> new wallet.What is wallet?
                </p>
                <div
        ...
        <div className="flex gap-2">
          ...
          <div className="flex-1">
            ...
            <p className="text-base text-secondary font-medium">
              Adipurush Final Trailer - Telugu
            </p>
          </div>
        </div>
        <div className="">
      ...
      <div className="px-3 pb-3">
        ...
        <p className="text-base-200">
          Adipurush is an adaptation of Indian mythology that depicts the
