...
const TrendingVideos = () => {
    ...
    return (<>
        <div className="mb-4 flex items-center justify-between mt-[34px]">
            <h3 className="text-xl font-medium textw-[390px]-secondary">Trending Now</h3>
            <div className="flex ">
        ...
        <div className="carousel gap-4 overflow-y-hidden max-sm:w-full">
           <div className="carousel-item shadow-lg"><MoviesCard/></div>
           <div className="carousel-item"> <MoviesCard/></div>
           <div className="carousel-item"> <MoviesCard/></div>
           <div className="carousel-item"> <MoviesCard/></div>
           <div className="carousel-item"> <MoviesCard/></div>
        </div>
