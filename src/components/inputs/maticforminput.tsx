  ...
  return (
    <div className="mt-2 relative">
      <div className={`input-group flex ${styles.maticInput}`}>
        ...
        <p className="min-h-[50px] !rounded-tl-[12px] !bg-primary !rounded-bl-[12px] !rounded-tr-[0px] !rounded-br-[0px] border-primary min-w-[126px] text-base-100 text-lg font-semibold text-center pt-[10px]">
          Matic
        </p>
        <input
          type="text"
         className="input disabled:!bg-inherit disabled:!cursor-default disabled:!text-neutral focus:outline-none input-bordered w-full !rounded-tr-[12px] !rounded-br-[12px] !rounded-tl-[0px] !rounded-bl-[0px] !border-[#343434] !h-[50px] border-l-0"
        ...
        />
        <div
          className={`${styles.maticActions} bg-transparent absolute flex gap-3 items-center right-3.5 top-3.5`}
        >
          <Button
            type="plain"
