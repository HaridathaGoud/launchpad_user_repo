import { Row, Col, Button, Nav, Card, Tabs, Tab, Container } from 'react-bootstrap';
            ...
            <Modal show={show} onHide={handleClose} className="wallet-popup checkout-modal">
              ...
              <Modal.Body>
                ...
                <InputGroup className="mb-4 input name-feild">
                  ...
                  <Form.Control placeholder="0.01" aria-label="Username" className="input-style" />
                </InputGroup>
                <InputGroup className="mb-4 input name-feild">
                  ...
                  <Tab eventKey="first" title="Overview">
                    <div>
                      <h3 className=" overview-space">
                        By <span className="overview-title-color">Doodles_LLC</span>
                      </h3>
                      <h3 className="overview-title">Description</h3>
                      <p className="overview-text">
                        The Doodle-y matter in the Dooplicator appears to be searching for new charges of utility for
                        its owner.
                      </p>
                    </div>
                  </Tab>
                ...
                <Row>
                  <Col lg={4} md={6} sm={6} efeed>
                    <div className="property-card mb-4">
                      <div className="p-2">
                        <span className="overview-title-color detail-card-label">OG Wearables Charge</span>
                  ...
                  <Col lg={4} md={6} sm={6}>
                    <div className="property-card mb-4">
                      <div className="p-2">
                        <span className="overview-title-color detail-card-label">Rarity</span>
                        <span className="detail-card-label">Very Common</span>
                        <span className="card-sub-label">67% have this trait</span>
                      </div>
                    </div>
                  </Col>
                  ...
                  <Col lg={4} md={6} sm={6}>
                    <div className="property-card mb-4  ">
                      <div className="p-2">
                        <span className="overview-title-color detail-card-label">Space Doodles Charge</span>
                        <span className="detail-card-label">Available</span>
                        <span className="card-sub-label">100% have this trait</span>
                      </div>
                    </div>
                  </Col>
                  <Col lg={4} md={6} sm={6}>
                    <div className="property-card mb-4">
                      <div className="p-2">
                        <span className="overview-title-color detail-card-label">Type</span>
            ...
            <Carousel autoPlaySpeed={1000} infinite responsive={responsive} className="corousel-arrows">
              <div className="creator-card">
                <Link className="nav-link" to={'/createby'}>
                  <Card className="creator-bg">
                    <div className="card-fixes">
                      <Image src={creatorcard} className="creator-img card-img" alt="" />
                    </div>
                    <Card.Body>
              ...
              <div className="creator-card">
                <Link className="nav-link" to={'/createby'}>
                  <Card className="creator-bg">
                    <div className="card-fixes">
                      <Image src={creatorcard2} className="creator-img card-img" alt="" />
                    </div>
                    <Card.Body>
                      <Card.Text>OriginalMyths#443</Card.Text>
                      <Card.Title>Original Myths NFT</Card.Title>
              ...
              <div className="creator-card">
                <Link className="nav-link" href={'/createby'}>
                  <Card className="creator-bg ">
                    <div className="card-fixes">
                      <Image src={creatorcard3} className="creator-img card-img" alt="" />
                    </div>
                    <Card.Body>
                      <Card.Text>OriginalMyths#443</Card.Text>
                      <Card.Title>Original Myths NFT</Card.Title>
              ...
              <div className="creator-card">
                <Link className="nav-link" to={'/createby'}>
                  <Card className="creator-bg  ">
                    <div className="card-fixes">
                      <Image src={creatorcard4} className="creator-img card-img" alt="" />
                    </div>
                    <Card.Body>
                      <Card.Text>OriginalMyths#443</Card.Text>
                      <Card.Title>Original Myths NFT</Card.Title>
              ...
              <div className="creator-card">
                <Link className="nav-link" to={'/createby'}>
                  <Card className="creator-bg">
                    <div className="card-fixes">
                      <Image src={creatorcard5} className="creator-img card-img" alt="" />
                    </div>
                    <Card.Body>
                      <Card.Text>OriginalMyths#443</Card.Text>
                      <Card.Title>Original Myths NFT</Card.Title>
