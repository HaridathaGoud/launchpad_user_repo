           ...
           <div>
            ...
            <h1 className='text-lg font-semibold text-secondary mb-5'>Price</h1>
                <div className="dropdown w-full">
                    <div tabIndex={0} role="button" className="border text-secondary flex border-secondary bg-transparent hover:bg-transparent rounded-[25px] !py-2 !px-[14px]  w-full justify-between">Matic <span className='icon drop-arrow'></span></div>
                ...
                <div className="join w-full mt-4">
                    <button className=" join-item bg-info-content border-0 text-secondary hover:bg-info-content rounded-tl-[25px] rounded-bl-[25px] text-sm font-normal !border-0 flex-1 py-2.5 px-[14px] text-left">Min</button>
                    ...
                    <button className=" join-item bg-info-content border-0 text-secondary hover:bg-info-content rounded-tr-[25px] rounded-br-[25px] text-sm font-normal flex-1 !border-0 px-[14px] text-right">Max</button>
                </div>
                <div className="text-right">
                    <Button children={'Apply'} btnClassName='uppercase mt-[18px] md:min-w-[132px]' type='secondary' />
                </div>
