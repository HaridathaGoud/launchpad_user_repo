        ...
        {profile.kycStatus && profile.kycStatus !== null && (
          <div>
            ...
            <p className="kyc-badge mt-1 txt-green break-all capitalize">
             <span className={`px-4 py-1 text-white rounded-md text-base font-semibold ${profile.kycStatus ==='Init' ? 'bg-orange-400':''}`}> {profile.kycStatus ? profile.kycStatus.toLowerCase() : "-"}</span>
            </p>
          </div>
        )}
