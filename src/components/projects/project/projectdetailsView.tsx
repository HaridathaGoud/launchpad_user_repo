            ...
            <div className="md:grid lg:grid-cols-12 mt-2 gap-7">
              <div className="lg:col-span-8">
                ...
                <div className="mt-2 mb-4">
                  ...
                  {!props.loader && (
                    <div id={"scrollTabs"} className="sticky top-[65px] z-10 flex items-center flex-col justify-center gap-3 pt-2 pb-2 md:flex-row md:justify-between bg-success-content">
