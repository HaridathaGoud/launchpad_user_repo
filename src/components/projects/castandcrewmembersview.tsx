    ...
    if (params.pjctId) {
      ...
      const getCastandcrews = async () => {
        ...
        const res = await get('User/castandcrews/' + params.pjctId)
          .then((res: any) => {
            setcastandcrews(res.data);setcastcrewsLoader(false)
          })
          .catch((error: any) => {
    ...
    return (
        <>
            <div className='container mx-auto'>                
               ...
               <div className="">
                          {castandcrews&&
                           <ProjectBanner bannerImage={castandcrews?.bannerImage || defaultbannerimg}/>
                          }
                        </div>
               ...
               {castandcrews.cast_Crews?.map((item)=><div className="card !bg-base-100 border border-slate-200 transform transition-transform duration-500 hover:scale-[1.03]">
                   <div className=''>
                   ...
                   <div className="card-body px-3 py-6 flex flex-row justify-between">
                        <div className='flex-1 overflow-hidden'>
                            <h1 className='text-base font-semibold mb-3 truncate'>{item.name}</h1>
                        ...
                        <h1 className='font-semibold mb-3'>-</h1>
                            ...
                            <p className='font-semibold mb-3 truncate'>{item.description}</p>
                        </div>
                ...
                <div className=''>
            {castcrewsLoader&&<FoundingMemberSimmer/>}
            </div>
