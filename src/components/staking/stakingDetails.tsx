      ...
      <div className="md:flex lg:ml-auto mt-4 lg-mt-0">
        <div className="flex gap-4 pe-5 ps-5 max-sm:mb-3">
          ...
          <div>
            ...
            <p className="text-xs font-normal text-primary">Staked</p>
          </div>
        </div>
        <div className="flex gap-4 md:border-x px-5">
          ...
          <div>
            ...
            <p className="text-xs font-normal text-primary">Unstaked</p>
          </div>
        </div>
        <div className="flex gap-4 ps-5">
          ...
          <div>
            ...
            <p className="text-xs font-normal text-primary">Rewards</p>
          </div>
        </div>
      </div>
    </div>
