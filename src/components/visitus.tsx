          ...
          <div className={`applynowSection max-sm:py-10 px-3 lg:px-0 max-sm:rounded py-[74px]`}>
            <div className={`container mx-auto lg:flex items-center justify-between`}>
                <div>
                    ...
                    <p className={`text-black text-base font-normal`}>Fill the form / Schedule a Free Call with our Experts / Brainstorm Ideas for your Project /<br/> Get your Quote / Project Development / Launch your Project</p>
                </div>
