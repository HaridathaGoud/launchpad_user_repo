    ...
    return (
        <>
            <div className={`ProjectCarousal relative mx-auto container `}>
                ...
                <div className={`carousel w-full rounded-2xl overflow-y-hidden ${props.className || ''}`}>
                    <div id="item1" className="carousel-item w-full block md:flex items-center md:gapx-5 lg:gapx-0">
                       <div className={`fullCarousal w-full max-sm:h-[380px]`}>
                       <Image src={aquaman} className={`carosalImage rounded-2xl w-full	 object-cover`} />
                       </div>

                    </div>
                    <div id="item1" className="carousel-item block md:flex w-full items-center md:gap-x-5 lg:gap-x-0">
                    <div className={`fullCarousal w-full`}>
                       <Image src={salarbanner} className={`carosalImage rounded-2xl w-full	max-sm:h-[380px] object-cover`} />
                       </div>
                    </div>
                    <div id="item1" className="carousel-item w-full block md:flex items-center md:gap-x-5 lg:gap-x-0">
                    <div className={`fullCarousal w-full`}>
                       <Image src={aquaman} className={`carosalImage rounded-2xl w-full	max-sm:h-[380px] object-cover`} />
                       </div>
