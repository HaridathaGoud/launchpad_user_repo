  ...
  return (
    <div className='container m-auto mt-2'>
       ...
       <div className='md:col-span-8'>
        ...
        <div className="w-full h-[16px] rounded-[12px] bg-slate-200 mt-6"></div>
        ...
        <div className="w-full md:w-[250px] h-[16px] rounded-[12px] bg-slate-200 mt-4"></div>
        <div className="w-full h-[16px] rounded-[12px] bg-slate-200 mt-2"></div>
        <div className='grid md:grid-cols-4 mt-4 gap-6'>
        <div className="w-full h-[160px] rounded-md bg-slate-200"></div>
        <div className="w-full h-[160px] rounded-md bg-slate-200"></div>
...
export default ProjectViewShimmer;