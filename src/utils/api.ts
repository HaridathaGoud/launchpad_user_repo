...
const COIN_GECKO_API_END_POINT = process.env.REACT_APP_COINGECKO_URL;
const STRAPI_ABOUT_US_DOC_PUBLISHED_URL =
  process.env.STRAPI_ABOUT_US_DOC_PUBLISHED_URL;
const COIN_GECKO_API_VERSION = "/api/v3/";
...
export async function postMarketplace(url: any, obj: any) {
  return await axios.post(
    MARKETPLACE_API_END_POINT + `${API_VERSION}${url}`,
    obj,
    {
      headers: {
        Authorization: `${getToken()}`,
...
const getDaoDetails = async (id) => {
  return await axios.get(
    API_END_POINT_DAO_CARDS + ApiControllers.user + `daodetails/${id}`,
    {
      headers: {
        Authorization: `${getToken()}`,
      },
...
const getMIntDaoDetails = async (take: any, skip: any) => {
  return await axios.get(
    `https://devmintingapi.minnapad.com/${API_VERSION}` +
      ApiControllers.user +
      `DaoDetails/${take}/${skip}`,
    {
      headers: {
...
const getProposalView = async (proposalId: any, customerId: any) => {
  return await axios.get(
    API_END_POINT_DAO +
      ApiControllers.user +
      `proposalview/${proposalId}/${customerId ? customerId : ""}`,
    {
      headers: {
        Authorization: `${getToken()}`,
      },
...
const postCreateProposal = async (obj) => {
  return await axios.post(
    API_END_POINT_DAO + ApiControllers.user + `createproposal`,
    obj,
    {
      headers: {
        Authorization: `${getToken()}`,
...
const postSaveVote = async (obj) => {
  return await axios.post(
    API_END_POINT_DAO + ApiControllers.user + `savevote`,
    obj,
    {
      headers: {
        Authorization: `${getToken()}`,
...
const getProposalList = async (
  ...
  return await axios.get(
    API_END_POINT_DAO +
      ApiControllers.user +
      `ProposalsList/${take}/${skip}/${daoId}/${status}/${searchBy}/${startDate}/${endDate}`,
    {
      headers: {
        Authorization: `${getToken()}`,
      },
...
const getContractDetails = async (daoId: any) => {
  return await axios.get(
    API_END_POINT_DAO + ApiControllers.user + `ContractDetails/${daoId}`,
    {
      headers: {
        Authorization: `${getToken()}`,
      },
...
const getProposalVotes = async (proposalId: any) => {
  return await axios.get(
    API_END_POINT_DAO + ApiControllers.user + `ProposalVotes/${proposalId}`,
    {
      headers: {
        Authorization: `${getToken()}`,
      },
...
const getProposalVoters = async (take: any, skip: any, proposalId: any) => {
  return await axios.get(
    API_END_POINT_DAO +
      ApiControllers.user +
      `proposalvoters/${take}/${skip}/${proposalId}`,
    {
      headers: {
        Authorization: `${getToken()}`,
      },
...
const customerVoted = async (proposalId: any, CustomerId: any) => {
  return await axios.get(
    API_END_POINT_DAO +
      ApiControllers.user +
      `isvotedcustomer/${proposalId}/${CustomerId}`,
    {
      headers: {
        Authorization: `${getToken()}`,
      },
...
const getUserInvestments = async (
  ...
  return await axios.get(
    API_END_POINT_DAO_CARDS +
      ApiControllers.user +
      `userinvestments/${customerId}/${take}/${skip}/${search}`,
    {
      headers: {
        Authorization: `${getToken()}`,
      },
...
const getUserclaims = async (
  ...
  return await axios.get(
    API_END_POINT_DAO_CARDS +
      ApiControllers.user +
      `userclaims/${customerId}/${take}/${skip}/${search}`,
    {
      headers: {
        Authorization: `${getToken()}`,
      },
...
const getDocsRestData = async () => {
  return await axios.get(
    "https://determined-duck-ea7e7c45e5.strapiapp.com/api/docs?populate=*"
  );
};
