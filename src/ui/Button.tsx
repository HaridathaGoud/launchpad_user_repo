...
const BtnStylings = {
  ...
  cancel:
    "px-[35px] py-2.5 rounded-[33px] border border-secondary bg-transparent hover:bg-black text-secondary hover:bg-secondary hover:text-base-100 font-semibold text-base h-[46px] !leading-5",
