...
const ErrorMessage = ({ errorMessage, setErrorMessage, onCloseCallback }) => {
  ...
  return (<>
    ...
    <div className="fixed top-15 left-[50%] right-[50%] translate-x-[-50%] z-[99999] w-[95%] md:w-[35%] my-4 ">
      <div className='rounded-lg flex border border-[#F05454] min-h-[50px] mt-5 shadow-lg relative bg-white'>
        ...
        <div className="bg-[#FF3838] w-[90px] relative flex justify-center items-center shrink-0 rounded-tl-md rounded-bl-md">
          <span className={`icon erroricon scale-[0.8]`}></span>
          <div className="w-0 h-0 border-l-[26px] border-l-[#FF3838] border-t-[16px] border-t-transparent and border-b-[16px] border-b-transparent absolute right-[-18px] top-[30%]"></div>
        </div>
