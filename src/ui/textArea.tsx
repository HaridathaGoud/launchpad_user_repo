  ...
  return (
    <div className={inputBoxClass}>
      ...
      <textarea
        ...
        className={
          inputClass ||
          "textarea textarea-bordered w-full disabled:bg-transparent text-secondary bg-transparent border-[#343434] resize-none leading-4 rounded-[12px] pl-5 pt-3 focus:outline-none"
        }
        rows={rows || 5}
